...
import cn.rongcloud.im.niko.viewmodel.MainContactsListViewModel;
...
public class MyContactsListFragment extends CommonListBaseFragment {
    ...
    protected CommonListBaseViewModel createViewModel() {
        viewModel = ViewModelProviders.of(MyContactsListFragment.this).get(MainContactsListViewModel.class);
