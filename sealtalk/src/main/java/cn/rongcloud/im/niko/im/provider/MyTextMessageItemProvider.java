...
public class MyTextMessageItemProvider extends TextMessageItemProvider {
    ...
    String[] colors = {"#11ff00", "#000000", "#1100ff"};
    ...
    public void bindView(View v, int position, TextMessage content, UIMessage data) {
        ...
        Log.e("width", holder.message.getMeasuredWidth() + "width");
    }
                    ...
                    public void run() {
                        ...
                        RongIM.getInstance().deleteMessages(msgs, new RongIMClient.ResultCallback<Boolean>() {
                            ...
                            public void onSuccess(Boolean aBoolean) {
                                Log.e("sclike3", "删除" + aBoolean);

                            }

                            @Override
                            public void onError(RongIMClient.ErrorCode errorCode) {
                                Log.e("sclike3", "删除 onError " + errorCode.getMessage());
